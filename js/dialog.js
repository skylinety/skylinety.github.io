...
if (toc != null) {
	window.addEventListener("scroll", throttle(scrollcatelogHandler, 1000));
	...
	function scrollcatelogHandler(e) {
		...
		if (toc.offsetHeight > CH - 30) {
			var eTop = getElementTop($(".nav-item.active")[0])
			var half = CH / 2
			console.log(eTop, half, eTop - half, '---')
			toc.style.top = (eTop - half) > 0 ? half - eTop + "px" : '30px'
		}
	}
}
